        ...
        <form class="card card-md" action="{{route('register')}}" method="post" autocomplete="off" novalidate>
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="Ingresa tu nombre de usuario">
                    @error('name')
                ...
                <div class="form-footer">
                    <button type="submit" class="btn btn-primary w-100">Crear una cuenta nueva</button>
                </div>
            </div>
        </form>
