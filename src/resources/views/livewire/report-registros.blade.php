<div>
    <div class="row row-deck row-cards">
                    ...
                    <div class="d-flex flex-row justify-content-between pb-1 ">
                        <div class="d-flex gap-2 text-muted align-items-center">
                            <div>
                                ...
                                <div class="d-flex align-items-center justify-content-center gap-1 flex-col">
                                    <div
                        ...
                        <button class="btn btn-warning rounded btn-sm {{sizeof($selectedLines) <= 0 ? "disabled": ""}}" data-bs-toggle="modal"
                            data-bs-target="#modal-convert"
                            wire:click="$dispatch('openConvertModal',{selectedLines: {{$selectedL}}})">Convertir</button>
                        ...
                        <thead>
                            <tr>
                                <th class="w-1"><input class="form-check-input m-0 align-middle" type="checkbox"
                                        aria-label="Select all invoices" wire:model.live="selectAll"></th>
                                @if($showFechaMov)
                                    <th>
                            ...
                            @foreach ($lineas as $linea)
                                <tr>
                                    <td><input class="form-check-input m-0 align-middle" type="checkbox"
                                            aria-label="Select Estado de cuenta" wire:model.live="selectedLines" value="{{$linea->id}}"></td>
                                    @if($showFechaMov)
        ...
        <livewire:modal-confirm-convert />
        <livewire:modal-convert />
